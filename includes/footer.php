   <footer>
        <div class="footerIn">
            ...
            <div class="navfooter">
                <a href="mentions-legales.php" class="BtnNavInside">Mentions légales</a>
                <a href="confidentialite.php" class="BtnNavInside">Confidentialité</a>
                <a href="contact.php" class="BtnNavInside">Contact</a>
            </div>
